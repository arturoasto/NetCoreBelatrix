...
namespace Belatrix.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddEntityFrameworkNpgsql()
                .AddDbContext<ApplicationDbContext>(opt => opt.UseNpgsql(Configuration.GetConnectionString("postgresql"), x => x.MigrationsAssembly("Belatrix.WebApi")))
                .BuildServiceProvider();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            SeedData.Initialize(app.ApplicationServices.GetRequiredService<IServiceScopeFactory>()
